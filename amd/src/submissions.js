...
define(['jquery'], function ($) {
    return {
        ...
        submissions: function () {
            ...
            var that = this;
            var originalityDropdown = $('#id_originality_use'),
                originalityDropdownGhostwriter = $('#id_originality_use_ghostwriter'),
                submitBtn = $('input[id=id_submitbutton], input[id=id_submitbutton2]'),
                originalityStatus = originalityDropdown.val(),

...
$string['originality_help'] = 'Ενεργοποιήστε την ανίχνευση πλαγιοκατασκευής για εργασίες βασισμένες σε κείμενο. Μην το χρησιμοποιείτε για εργασίες σε διάφορες γλώσσες ή για μηχανολογικές εργασίες, καθώς το μηχανισμός δεν έχει σχεδιαστεί για αυτό.';
...
$string['service_is_inactive'] = 'Το πρόσθετο Αυθεντικότητας δεν είναι ενεργό. Παρακαλώ επικοινωνήστε με τον διαχειριστή του Moodle.';
$string['warning_message'] = "Πρέπει να επιλέξετε το πλαίσιο συναίνεσης ('Είμαι ενημερωμένος και συμφωνώ') για να ενεργοποιήσετε το κουμπί υποβολής.";
$string['previous_submissions'] = 'Υπάρχουν ήδη υποβληθείσες εργασίες. Αυτοί οι φοιτητές πρέπει να υποβάλουν ξανά την εργασία τους για να γίνει ο έλεγχος αυθεντικότητας.';
$string['production_endpoint'] = '<b>Παραγωγικός Διακομιστής</b>&nbsp;&nbsp;<span style="font-size:14px;">Υποβολή εργασιών στον παραγωγικό διακομιστή της Αυθεντικότητας.</span>';
$string['test_endpoint'] = '<b>Δοκιμαστικός Διακομιστής</b>&nbsp;&nbsp;<span style="font-size:14px;">Υποβολή εργασιών στον δοκιμαστικό διακομιστή της Αυθεντικότητας. Επιλέξτε αυτήν την επιλογή μόνο μετά από συνεννόηση με την Αυθεντικότητα.</span>';
$string['check_ghostwriter'] = 'Έλεγχος Σκιώδους Συγγραφέα για Μεγάλες Εργασίες';
$string['check_ghostwriter_help'] = 'Μπορείτε να ενεργοποιήσετε αυτό το πρόσθετο μόνο μετά από συνεννόηση με την Αυθεντικότητα. Χωρίς προηγούμενη συνεννόηση, το πρόσθετο δεν θα λειτουργήσει.';
